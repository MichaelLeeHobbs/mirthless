...
// ===========================================
// Collapsible section for editing source transformer steps within the Source tab.
...
import type { TransformerFormValues, TransformerStepFormValues } from './types.js';
import { createDefaultTransformerStep } from './types.js';
import { TransformerStepEditor } from './TransformerStepEditor.js';
...
interface SourceTransformerSectionProps {
  readonly transformer: TransformerFormValues;
  readonly onChange: (transformer: TransformerFormValues) => void;
}

export function SourceTransformerSection({ transformer, onChange }: SourceTransformerSectionProps): ReactNode {
  ...
  return (
    <Accordion disableGutters>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <Typography sx={{ fontWeight: 600, mr: 2 }}>Source Transformer</Typography>
