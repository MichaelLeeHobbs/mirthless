...
--> statement-breakpoint
CREATE TABLE "channel_transformers" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"channel_id" uuid NOT NULL,
	"connector_id" uuid,
	"inbound_data_type" varchar(50) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "transformer_steps" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "channel_metadata_columns" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"channel_id" uuid NOT NULL,
	"name" varchar(255) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "channel_tag_assignments" (
	"channel_id" uuid NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "code_template_libraries" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"name" varchar(255) NOT NULL,
	"description" text DEFAULT '',
	"revision" integer DEFAULT 1 NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "global_map_entries" (
...
CREATE INDEX "users_enabled_idx" ON "users" USING btree ("enabled");--> statement-breakpoint
...
CREATE UNIQUE INDEX "channel_connectors_channel_meta" ON "channel_connectors" USING btree ("channel_id","meta_data_id");--> statement-breakpoint
CREATE INDEX "filter_rules_filter_seq" ON "filter_rules" USING btree ("filter_id","sequence_number");--> statement-breakpoint
CREATE INDEX "transformer_steps_trans_seq" ON "transformer_steps" USING btree ("transformer_id","sequence_number");--> statement-breakpoint
CREATE UNIQUE INDEX "channel_scripts_channel_type" ON "channel_scripts" USING btree ("channel_id","script_type");--> statement-breakpoint
CREATE UNIQUE INDEX "channel_metadata_cols_channel_name" ON "channel_metadata_columns" USING btree ("channel_id","name");--> statement-breakpoint
CREATE INDEX "messages_received_idx" ON "messages" USING btree ("channel_id","received_at");--> statement-breakpoint
CREATE INDEX "messages_processed_idx" ON "messages" USING btree ("channel_id","processed");--> statement-breakpoint
CREATE INDEX "connector_messages_status_idx" ON "connector_messages" USING btree ("channel_id","meta_data_id","status");--> statement-breakpoint
CREATE INDEX "connector_messages_queued_idx" ON "connector_messages" USING btree ("channel_id","meta_data_id","status") WHERE status = 'QUEUED';--> statement-breakpoint
CREATE INDEX "message_custom_metadata_gin" ON "message_custom_metadata" USING gin ("metadata");--> statement-breakpoint
CREATE INDEX "message_attachments_message_idx" ON "message_attachments" USING btree ("channel_id","message_id");--> statement-breakpoint
...
CREATE INDEX "events_channel_id_idx" ON "events" USING btree ("channel_id");