...
| 2.10 | Handles long channel names  | Create channel with 255 character name           | Name is truncated in list but shows full on hover/editor           | pass   |       |
---
...
| 4.2  | Name max length                  | Enter 256+ characters in name field                   | Validation error "Max 255 characters" shown                             | partial | Extremely long name breaks page formatting. The issues is the name at the top of the view. Causes horizontal scroll and layout issues. We should truncate the name in the header and show full name on hover. |
| 4.3  | Description field                | Enter multiline description, save, reload             | Description persists correctly                                          | pass    |                                                                                                                                                                                                               |
...
| #     | Scenario                    | Steps                                                   | Expected                                                                                 | Result | Notes |
|-------|-----------------------------|---------------------------------------------------------|------------------------------------------------------------------------------------------|--------|-------|
| 5a.1  | Default form loads          | Create new channel (default TCP_MLLP), go to Source tab | TCP/MLLP form displayed with defaults: host `0.0.0.0`, port `6661`, max connections `10` | pass   |       |
| 5a.2  | Host field editable         | Change host to `127.0.0.1`                              | Field updates                                                                            | pass   |       |
| 5a.3  | Port field — valid value    | Change port to `2575`                                   | Field accepts the value                                                                  | pass   |       |
| 5a.4  | Port field — min/max        | Try port `0` and `65536`                                | Validation prevents values outside 1-65535                                               | pass   |       |
| 5a.5  | Max connections field       | Change to `20`                                          | Field accepts the value                                                                  | pass   |       |
| 5a.6  | Keep connection open switch | Toggle the switch off and on                            | Switch state changes visually                                                            | pass   |       |
| 5a.7  | Charset dropdown            | Click charset field                                     | Shows: UTF-8, ISO-8859-1, US-ASCII                                                       | pass   |       |
| 5a.8  | Transmission mode dropdown  | Click transmission mode field                           | Shows: MLLP, RAW, DELIMITED                                                              | pass   |       |
| 5a.9  | Receive timeout field       | Set to `30000`                                          | Field accepts the value                                                                  | pass   |       |
| 5a.10 | Buffer size field           | Set to `131072`                                         | Field accepts the value                                                                  | pass   |       |
| 5a.11 | Settings persist on save    | Modify several fields, save, reload page                | All TCP/MLLP settings preserved exactly                                                  | pass   |       |

### 5b. HTTP Connector

| #    | Scenario                     | Steps                                                                  | Expected                                                                         | Result | Notes |
|------|------------------------------|------------------------------------------------------------------------|----------------------------------------------------------------------------------|--------|-------|
| 5b.1 | Switch to HTTP connector     | On Summary tab, change Source Connector Type to HTTP, go to Source tab | HTTP form displayed with defaults: host `0.0.0.0`, port `8080`, context path `/` | pass   |       |
| 5b.2 | Host field editable          | Change host to `127.0.0.1`                                             | Field updates                                                                    | pass   |       |
| 5b.3 | Port field                   | Change port to `9090`                                                  | Field accepts the value                                                          | pass   |       |
| 5b.4 | Context path field           | Change to `/api/messages`                                              | Field accepts the value                                                          | pass   |       |
| 5b.5 | Allowed methods multi-select | Click methods field, select GET and POST                               | Both methods shown as chips                                                      | pass   |       |
| 5b.6 | Response status code         | Change to `202`                                                        | Field accepts the value                                                          | pass   |       |
| 5b.7 | Response content type        | Change to `application/json`                                           | Field updates                                                                    | pass   |       |
| 5b.8 | Settings persist on save     | Modify several fields, save, reload page                               | All HTTP settings preserved exactly                                              | pass   |       |
