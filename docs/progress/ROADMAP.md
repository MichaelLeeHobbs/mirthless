...
### Remaining for v1.0
- [ ] Data type serialization — XML/JSON/HL7v2 parsed `msg` object in sandbox (not just raw string)
- [ ] Inbound data validation — reject malformed messages at source connector
