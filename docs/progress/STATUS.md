...
> Last updated: 2026-03-02 (Phase 20 Config Management, System Info & Dashboard Enhancements)

## Package Status

| Package | Phase | What's Done | What's Next |
|---------|-------|-------------|-------------|
| `@mirthless/core-models` | Complete (v1) | Branded types, constants, Zod schemas (channel CRUD, destinations, metadata, users, **code templates**, **global scripts**, **filters**, **transformers**, **alerts**, **events**, **settings**, **global map**, **config map**), **SOCKET_EVENT constants**, **EVENT_NAME constants**, **184 schema validation tests** | Refine schemas as features develop |
...
| Manual test suite | Done | 45 test files, ~870 scenarios, `docs/testing/` |
...
| `pnpm test` | PASS | **1,320 tests passing** (184 schema + 68 HL7 + 196 engine + 321 connectors + 529 server + 22 CLI) |
